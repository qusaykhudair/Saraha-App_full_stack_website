...
import { Facebook, Github, Instagram, Linkedin, Send, MessageSquare, Heart, ShieldCheck } from 'lucide-react';
      ...
      <div className="container">
        <div className="grid grid-3" style={{ marginBottom: '3rem', gap: '3rem' }}>
          ...
          <div className="flex flex-col gap-md">
            ...
            <div className="flex gap-sm">
              <SocialBtn href="https://www.facebook.com/m.qsy.khdyr" icon={<Facebook size={18} />} color="#1877F2" />
              <SocialBtn href="https://github.com/qusaykhudair" icon={<Github size={18} />} color="#fff" />
              <SocialBtn href="https://www.instagram.com/eng.qusay.khudair" icon={<Instagram size={18} />} color="#E4405F" />
              <SocialBtn href="https://www.linkedin.com/in/eng-qusay-khudair-bb8303262" icon={<Linkedin size={18} />} color="#0A66C2" />
              <SocialBtn href="https://t.me/eng_Qusay_kh" icon={<Send size={18} />} color="#229ED9" />
            </div>
          </div>
        ...
        <div style={{ 
          ...
          <p style={{ color: 'var(--text-secondary)', fontSize: '0.95rem' }}>
            Development with <Heart size={14} color="#ff4081" fill="#ff4081" /> by <span className="text-gradient" style={{ fontWeight: '700' }}>Eng Qusay khudair</span>
          </p>
